/**
 * auth.js — Login gate (login, register, admin), logout, dan verifikasi pengembalian.
 */

/* Ganti tab di login gate */
...
/* Logout — hapus session, tampilkan gate lagi */
...
/* Verifikasi pengembalian buku (modal return) */
...
/* Tampilkan/sembunyikan gate */
function showGate() {
    document.getElementById('login-gate').classList.remove('hidden');
    /* Reset semua form gate */
